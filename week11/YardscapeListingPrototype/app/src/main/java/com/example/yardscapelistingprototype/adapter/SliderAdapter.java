...
public class SliderAdapter extends SliderViewAdapter<SliderAdapter.SliderAdapterVH> {
    ...
    private List<Listing> mSliderItems = new ArrayList<>();

    // constructor for our adapter class. 
    public SliderAdapter(Context context, List<Listing> mSliderItems) {
    ...
    public void onBindViewHolder(SliderAdapterVH viewHolder, int position) {
        ...
        final Listing sliderItem = mSliderItems.get(position);
        Picasso.get().load(sliderItem.getListing_image_path()).into(viewHolder.imageView);
    }
    ...
    class SliderAdapterVH extends SliderViewAdapter.ViewHolder {
        ...
        public SliderAdapterVH(View itemView) {
            ...
            imageView = itemView.findViewById(R.id.openSliderimage);
